...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2021 at 11:58 PM
...
ALTER TABLE `history`
  ...
  ADD KEY `history_to_client` (`client_id`);
...
--
ALTER TABLE `history`
  ADD CONSTRAINT `history_to_client` FOREIGN KEY (`client_id`) REFERENCES `client` (`client_id`),
